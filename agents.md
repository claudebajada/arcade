...
- [ ] **Back button** → `Maps("/")` labelled `← ODD NOODLE` (or similar friendly label)
...
## Asking An AI Agent (Claude or Codex) to Build a Game

When prompting an AI (Claude or Codex/ChatGPT) to create a game for Odd Noodle Games, use this template:
...
> - The games should strive to be slightly quirky
