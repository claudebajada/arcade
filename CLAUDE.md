...
- **Bug fix / Refactoring** — read the relevant game file and the Coding Standards section of AGENTS.md; preserve the single-file rule and inline-styles-only constraint.
